    ...
    describe('given we try to set the value of destroy$ ourselves', () => {
        it('should throw an error', () => {
            expect(() => {
                ...
                const instance = new MyComponent();
            }).toThrowError('You cannot set this property in the Component if you use @Destroy')
        });
    });
});
    ...
    describe('given we try to set the value of change$ ourselves', () => {
        it('should throw an error', () => {
            expect(() => {
                ...
                const instance = new MyComponent();
            }).toThrowError('You cannot set this property in the Component if you use @Changes')
        });
    });
});
